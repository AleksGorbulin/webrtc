        ...
        for (let [key, value] of map2) {
            if (username != key) { 
                ...
                document.getElementById('lstChat').innerHTML += "<li class='list-group-item list-group-item-action'>" +
                    ...
                    "</div>" +
                    "<div class='col-md-4' style='cursor:pointer;'>" +
                    "<button class='btn btn-success' type='button'    onmousedown='call_user(\"" + key + "\")' onmouseup='Leaveroom()'>" +
                    "<span class='glyphicon glyphicon-facetime-video'></span><i class='fas fa-bullhorn'></i>" +
                    "</button>" +
                    "</div>" +
                    "</li>";
